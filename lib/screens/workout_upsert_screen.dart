...
class _WorkoutUpsertScreenState extends State<WorkoutUpsertScreen> {
  ...
  Future<void> _save() async {
    ...
    if (!editing) {
      await WorkoutService.instance.insert(
        Workout(
          type: _type.value,
          sets: sets,
          reps: reps,
      ...
      final w = widget.existing!;
      await WorkoutService.instance.update(
        w.copyWith(
          type: _type.value,
          sets: sets,
          reps: reps,
          ...
          children: [
            ValueListenableBuilder(
              ...
              builder: (_, v, __) => DropdownButtonFormField(
                value: v,
                items: const ['Run','Walk','Volleyball ','Lift - Deadlift', 'Lift - Barbell Squat','Lift - Bench press','football']
